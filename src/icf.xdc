## Nexys A7-100T constraints for this project.
## Adapted from /Users/picopico/Downloads/Nexys-A7-100T-Master.xdc.
...
set_property -dict { PACKAGE_PIN K13   IOSTANDARD LVCMOS33 } [get_ports { disp_seg_o[3] }]; #IO_L17P_T2_A26_15 Sch=cd
