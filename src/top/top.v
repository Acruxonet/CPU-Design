...
module top(
    ...
    wire        mem_w;
    wire [2:0]  dm_ctrl;
    wire [31:0] reg_data_unused;

    wire [31:0] ram_data_in_unused;
    wire [9:0]  ram_addr_unused;
    wire [9:0]  ram_addr;
    wire [31:0] douta;
    wire [31:0] dina;
    ...
    MIO_BUS U4_MIO_BUS(
        ...
        .ram_data_in(ram_data_in_unused),
        .ram_addr(ram_addr_unused),
        .data_ram_we(data_ram_we_unused),
