...
module SCPU(
    ...
    assign reg_data = (wb_regwrite && (mem_wb_rd != 5'd0) &&
                       (mem_wb_rd == reg_sel)) ? wb_wd : rf_reg_data_raw;
    ...
    assign DMType   = ex_mem_valid ? ex_mem_dmtype : `dm_word;
